...
//if(isset($_SESSION["login"]) && $_SESSION["role"]=="admin"){
	echo'<li class="nav-item">
	    ...
	    echo'<li class="nav-item">
	      ...
	      echo'<li class="nav-item">
	        <a class="nav-link" href="index.php?page=ajoutEtapeControleur">Etapes</a>
	      </li>';
	     // }
	    //if(isset($_SESSION["login"])){
	      echo' <li class="nav-item ">
        <a class="nav-link" href="ajoutDocument.php">document</i>
          <!-- <span class="sr-only">(current)</span> -->
        </a>
      </li>
      <li class="nav-item">';
    echo'<li class="nav-item">
	        <a class="nav-link" href="../framework/index.php">Déconnexion</a>
	      </li>';
